...
@Component({
  selector: 'app-compare-detail-panel',
  templateUrl: './compare-detail-panel.component.html',
  styleUrls: ['./compare-detail-panel.component.css']
})
export class ComparedetailpanelComponent implements OnInit {
  ...
  ngOnInit() {
    this.selectedProtocol = this.transmitDataService.getProtocol();
    this.organName = this.selectedProtocol['organ']?this.selectedProtocol['organ']:this.selectedProtocol.rightprotocol.organ;;
    ...
    this.items = [];
    this.items.push({label:'Home',url:'./requestlist'});
    this.items.push({label:'Request List', url:'./requestlist'});
    this.items.push({label:'Compare Detail'});
  }
  ngOnDestroy(){
  ...
  private getParameterList(){
    ...
    this.requestListService.getOtherProtocols({
        ...
        let organName = this.selectedProtocol['organ']?this.selectedProtocol['organ']:this.selectedProtocol.rightprotocol.organ;
        if(organName == this.organName){
